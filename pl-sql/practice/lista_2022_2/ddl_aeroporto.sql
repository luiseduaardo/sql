-- 1. Excluindo as tabelas com maior nível de dependência (Filhas)
DROP TABLE Escala_tb CASCADE CONSTRAINTS;
DROP TABLE Trabalha_tb CASCADE CONSTRAINTS;
DROP TABLE Passagem_tb CASCADE CONSTRAINTS;

-- 2. Excluindo tabelas intermediárias
DROP TABLE Compra_tb CASCADE CONSTRAINTS;
DROP TABLE Voo_tb CASCADE CONSTRAINTS;
DROP TABLE Aviao_tb CASCADE CONSTRAINTS;
DROP TABLE Modelo_aviao_tb CASCADE CONSTRAINTS;
DROP TABLE Telefone_Comp_aerea_tb CASCADE CONSTRAINTS;
DROP TABLE Bagagem_tb CASCADE CONSTRAINTS;
DROP TABLE Endereco_tb CASCADE CONSTRAINTS;
DROP TABLE Telefone_Pessoa_tb CASCADE CONSTRAINTS;

-- 3. Excluindo as tabelas de entidades primárias (Pais)
DROP TABLE Comp_aerea_tb CASCADE CONSTRAINTS;
DROP TABLE Passageiro_tb CASCADE CONSTRAINTS;
DROP TABLE Tripulante_tb CASCADE CONSTRAINTS;
DROP TABLE CEP_tb CASCADE CONSTRAINTS;
DROP TABLE Pessoa_tb CASCADE CONSTRAINTS;

-- 4. Excluindo as sequências
DROP SEQUENCE Tripulante_seq;
